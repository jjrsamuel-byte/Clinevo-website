...
function postPage({ slug, title, date, description, image, html }, { nav, footer, headExtras }) {
  return `<!DOCTYPE html>
<html lang="en-GB">
<head>
<meta charset="UTF-8">
...
<div class="blog-post-wrap">
  <div class="post-container">
    <main class="post-main">
      ${image ? `<div class="post-hero-image"><img src="${image}" alt="${escHtml(title)}"></div>` : `<div class="post-illustration">
