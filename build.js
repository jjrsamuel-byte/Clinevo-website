...
const ILLUSTRATIONS = {
  ...
  kshape: `<svg viewBox="0 0 600 300" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <!-- Tick beside phone -->
          <path d="M274 93 L277 97 L283 89" stroke="#45C4BC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          ...
          <!-- Calendar shape -->
          <rect x="336" y="51" width="18" height="15" rx="2.5" fill="none" stroke="#45C4BC" stroke-width="1.8"/>
          <line x1="336" y1="56" x2="354" y2="56" stroke="#45C4BC" stroke-width="1.5"/>
          <!-- Calendar handles -->
          <line x1="341" y1="48" x2="341" y2="53" stroke="#45C4BC" stroke-width="1.8" stroke-linecap="round"/>
          <line x1="349" y1="48" x2="349" y2="53" stroke="#45C4BC" stroke-width="1.8" stroke-linecap="round"/>
          ...
          <path d="M339 63 L341 65 L344 62" stroke="#45C4BC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <path d="M346 63 L348 65 L351 62" stroke="#45C4BC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          ...
          <line x1="439" y1="40" x2="439" y2="26" stroke="#45C4BC" stroke-width="2.2" stroke-linecap="round"/>
          <polyline points="434,31 439,25 444,31" stroke="#45C4BC" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          ...
          <!-- X mark -->
          <line x1="274" y1="176" x2="281" y2="183" stroke="rgba(183,74,74,0.6)" stroke-width="2" stroke-linecap="round"/>
          <line x1="281" y1="176" x2="274" y2="183" stroke="rgba(183,74,74,0.6)" stroke-width="2" stroke-linecap="round"/>
          ...
          <line x1="429" y1="242" x2="429" y2="256" stroke="rgba(183,74,74,0.5)" stroke-width="2.2" stroke-linecap="round"/>
          <polyline points="424,251 429,257 434,251" stroke="rgba(183,74,74,0.5)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
